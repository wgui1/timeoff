 ...
 * @since 3.2
 */
public final class FormLoginConfigurer<H extends HttpSecurityBuilder<H>> extends AbstractAuthenticationFilterConfigurer<H,FormLoginConfigurer<H>,DomainUsernamePasswordAuthenticationFilter> {
    ...
    public FormLoginConfigurer() {
        super(new DomainUsernamePasswordAuthenticationFilter(), null);
        usernameParameter("username");
        passwordParameter("password");
        domainParameter("domain");
    }
    ...
    public FormLoginConfigurer<H> domainParameter(String domainParameter) {
        getAuthenticationFilter().setDomainParameter(domainParameter);
        return this;
    }
