...
import cn.timeoff.security.service.DomainUserDetailsService;


@SuppressWarnings("deprecation")
public class DomainDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public DomainDaoAuthenticationProvider() {
    ...
    protected void doAfterPropertiesSet() throws Exception {
        Assert.notNull(this.domainUserDetailsService, "A UserDetailsService must be set");
    }
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
        ...
        if (authentication instanceof DomainSecurityAuthenticationToken) {
            String domain = ((DomainSecurityAuthenticationToken) authentication).getDomain();
            logger.debug ("DOMAIN: " + domain);

            try {
                loadedUser = this.getUserDetailsService().loadUserByDomainNameAndUsername(domain, username);
            ...
            logger.debug(  "authentication is not instance of DomainSecurityAuthenticationToken: "
    ...
    public void setUserDetailsService(UserDetailsService userDetailsService) {
        Assert.isTrue(userDetailsService instanceof DomainUserDetailsService);
        this.domainUserDetailsService = (DomainUserDetailsService) userDetailsService; 
    }

    protected DomainUserDetailsService getUserDetailsService() {
